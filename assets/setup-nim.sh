...
mkdir -p $LOCAL_PEFT_DIRECTORY/llama3.1-8b-foodgen
cp ./results/Meta-llama3.1-8B-Instruct-foodgen/checkpoints/megatron_gpt_peft_lora_tuning.nemo $LOCAL_PEFT_DIRECTORY/llama3.1-8b-foodgen
